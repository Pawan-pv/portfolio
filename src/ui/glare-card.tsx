...
export const GlareCard = ({
  ...
  return (
    <div className=" ">
      ...
      className="relative  isolate [contain:layout_style] [perspective:600px] transition-transform duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] will-change-transform w-[200px] [aspect-ratio:17/21] md:w-[280px]"
      ref={refElement}
      onPointerMove={(event) => {
